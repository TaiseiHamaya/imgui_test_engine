...
#if defined(IMGUI_APP_WIN32_DX11) || defined(IMGUI_APP_WIN32_DX12) || defined(IMGUI_APP_SDL2_GL2) || defined(IMGUI_APP_SDL2_GL3) || defined(IMGUI_APP_SDL3_GL3) || defined(IMGUI_APP_GLFW_GL3)
    app->OptGui = true;
#endif
